  ...
  def create
    ...
    respond_to do |format|
      if @project.save
        ...
        format.json { render :show, status: :created, location: tenant_project_url(@project, tenant_id: @tenant) }
      else
  ...
  def update
    respond_to do |format|
      if @project.update(project_params)
        ...
        format.json { render :show, status: :ok, location: tenant_project_url(@project, tenant_id: @tenant.id) }
      else
